...
## Purpose
Remove all JIRA environment variables from the application. Use JSON config files as the **only** source of truth for JIRA configuration. This enables running multiple workers with different JIRA instances simultaneously.
